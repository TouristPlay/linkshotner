<div>
    ...
    <x-jet-form-section submit="createApiToken">
        <x-slot name="title">
            {{ __('Создать API Token') }}
        </x-slot>

        <x-slot name="description">
            {{ __('Токены API позволяют сторонним службам проходить аутентификацию в нашем приложении от вашего имени.') }}
        </x-slot>
    ...
    <x-jet-dialog-modal wire:model="displayingToken">
        ...
        <x-slot name="content">
            <div>
                {{ __('Скопируйте новый токен API. Для вашей безопасности он больше не будет отображаться.') }}
            </div>
