<x-app-layout>
                ...
                <div class="mt-10 sm:mt-0">
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="flex mt-5 md:mt-0 md:col-span-1 justify-center items-center">
                            <h1 class="text-3xl md:ml-7 sm:ml-0">Сокращение ссылки</h1>
                        </div>
                                ...
                                <div class="shadow overflow-hidden sm:rounded-md">
                                    <div class="px-4 py-5 bg-white sm:p-6">
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-6">
                                                <label for="url" class="block text-sm font-medium text-gray-700">Ссылка</label>
    ...
    <script>
        $(document).ready(function () {
            $('#slug').keyup(function () {
                $('#linkFinal').text("Shortened Link: " + {!! json_encode(config('app.url')) !!} + $(this).val().replaceAll(' ', '-'));
